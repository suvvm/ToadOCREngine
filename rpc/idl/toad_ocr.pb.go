...
type PredictRequest struct {
	...
	Image   []float64 `protobuf:"fixed64,2,rep,packed,name=image,proto3" json:"image,omitempty"`
}
...
func (x *PredictRequest) GetImage() []float64 {
	if x != nil {
		return x.Image
	}
	return nil
...
var file_toad_ocr_proto_rawDesc = []byte{
	...
	0x0a, 0x05, 0x69, 0x6d, 0x61, 0x67, 0x65, 0x18, 0x02, 0x20, 0x03, 0x28, 0x01, 0x52, 0x05, 0x69,
