...
type PredictRequest struct {
	...
	Image   []float32 `protobuf:"fixed32,2,rep,packed,name=image,proto3" json:"image,omitempty"`
}
...
func (x *PredictRequest) GetImage() []float32 {
	if x != nil {
		return x.Image
	}
	return nil
...
func (x *PredictReply) GetCode() string {
	if x != nil {
		return x.Code
	}
	return ""
...
func (x *PredictReply) GetMsg() string {
	if x != nil {
		return x.Msg
	}
	return ""
...
var file_toad_ocr_proto_rawDesc = []byte{
	...
	0x65, 0x22, 0x41, 0x0a, 0x0e, 0x50, 0x72, 0x65, 0x64, 0x69, 0x63, 0x74, 0x52, 0x65, 0x71, 0x75,
	...
	0x0a, 0x05, 0x69, 0x6d, 0x61, 0x67, 0x65, 0x18, 0x02, 0x20, 0x03, 0x28, 0x02, 0x52, 0x05, 0x69,
	0x6d, 0x61, 0x67, 0x65, 0x22, 0x4a, 0x0a, 0x0c, 0x50, 0x72, 0x65, 0x64, 0x69, 0x63, 0x74, 0x52,
	...
	0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6d, 0x73, 0x67, 0x12, 0x14, 0x0a, 0x05, 0x6c, 0x61,
